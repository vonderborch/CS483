...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url().'application/styles/reset.css'; ?>" type="text/css" media="screen, projection">
    
    <link rel="stylesheet" href="<?php echo base_url().'application/styles/jquery/jquery-ui.css'; ?>" type="text/css" media="screen, projection">

    <!-- desktop css -->
    <link rel="stylesheet" href="<?php echo base_url().'application/styles/stylesheet.css'; ?>" type="text/css" media="screen, projection">
...
<body>
    ...
    <div id="header">
        ...
        <h3 id="header-menu"><?php echo anchor('Blog/Index', 'Home'); ?>  |  <?php echo anchor('Blog/ListPosts', 'Posts'); ?>  |   <?php echo anchor('Blog/GameList', 'Games'); ?>  |   
        <?php 
        if (isset($_SESSION["username"]))
        {
            ...
            {
                echo "  |  ";
                echo anchor('Admin/AdminIndex', 'Administration');
            }

            echo "  |  ";
            echo anchor('Admin/EditUser/'.$_SESSION["id"], 'Settings');
